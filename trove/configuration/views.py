...
class ConfigurationView(object):
    ...
    def data(self):
        configuration_dict = {
            ...
            "datastore_version": self.configuration.datastore_version,
        }
...
class DetailedConfigurationView(object):
    ...
    def __init__(self, configuration, configuration_items, instances):
        self.configuration = configuration
    ...
    def data(self):
        ...
        for configItem in self.configuration_items:
            ...
            values[key] = value
        instances = DetailedConfigurationInstancesView(
        ...
        configuration_dict = {
            ...
            "values": values,
            "instances": instances,
            "datastore_version": self.configuration.datastore_version_id,
        }
