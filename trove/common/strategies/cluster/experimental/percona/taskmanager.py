...
class PerconaTaskManagerStrategy(base.BaseTaskManagerStrategy):
    ...
    def task_manager_cluster_tasks_class(self):
        return PerconaClusterTasks


class PerconaClusterTasks(task_models.ClusterTasks):
    ...
    def create_cluster(self, context, cluster_id):
        ...
        def _render_cluster_config(instance, cluster_ips, cluster_name,
                                   replication_user):
        ...
        def _create_cluster():
            ...
            LOG.debug("waiting for the instances to go active....")
            ...
            # Percona cluster name must be unique and be shorter than a full
            ...
            try:
                ...
                for instance in instances:
                    ...
                    cluster_configuration = _render_cluster_config(
