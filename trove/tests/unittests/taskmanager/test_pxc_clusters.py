...
from trove.common.strategies.cluster.experimental.percona.taskmanager import (
    PerconaClusterTasks as ClusterTasks)
from trove.common.strategies.cluster.experimental.percona.taskmanager import (
    PerconaTaskManagerStrategy as task_strategy)
...
class PerconaClusterTasksTest(trove_testtools.TestCase):
    def setUp(self):
        super(PerconaClusterTasksTest, self).setUp()
        util.init_db()
...
class PerconaTaskManagerStrategyTest(trove_testtools.TestCase):
