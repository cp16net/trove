...
from trove.common.strategies.cluster.experimental.percona.guestagent import (
    PerconaGuestAgentAPI)
...
class ApiTest(trove_testtools.TestCase):
    ...
    def setUp(self, *args):
        ...
        self.guest = PerconaGuestAgentAPI(self.context, 0)
        self.guest._call = _mock_call
        self.api = PerconaGuestAgentAPI(self.context, "instance-id-x23d2d")
